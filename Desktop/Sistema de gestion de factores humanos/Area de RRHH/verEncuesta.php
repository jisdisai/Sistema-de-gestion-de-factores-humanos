...
<HTML>
	<HEAD>
		<TITLE>Visualización de Encuesta</TITLE>
		<META charset="UTF-8">
	...
	<BODY bgcolor="#B2BABB" id="cuerpo" onload="obtenerPreguntas()" style="margin: 0;padding: 0">
		<div id="encabezado">
			<button id="boton_volver" onclick="location.href='area_rrhh.php'">Volver</button>
			...
			<div id="div_identificadorUsuario">
				<div id="div_iconoUsuario">
					<div id="circulo">
						<img src="iconos\rrhh.png" style="width: 50%; height: 50%">
					</div>
				</div>
